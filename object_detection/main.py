...
class ObjectDetection(object):
    ...
    def process_prediction(self, results_pandas):
        labels = {"0": "biker", "1": "car", "2": "pedestrian", "3": "trafficLight", "4": "trafficLight-Green", "5": "trafficLight-GreenLeft",
                  "6": "trafficLight-Red", "7": "trafficLight-RedLeft", "8": "trafficLight-Yellow", "9": "trafficLight-YellowLeft", "10": "truck"}
    ...
    def process(self, frame):
        ...
        stop, processed_prediction = self.process_prediction(
